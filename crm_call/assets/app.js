...
const App = {
    ...
    async bootApp() {
        ...
        try {
            ...
            this.loadDashboardStats(); // Load stats on boot
    ...
    switchView(target) {
        ...
        if (target === 'dashboard') this.loadDashboardStats();
    ...
    async loadDashboardStats() {
        try {
            ...
            if (res.ok) {
                ...
                const elCamp = document.getElementById('stat-campaigns');
                const elAgents = document.getElementById('stat-agents');

                if (elCamp) elCamp.innerText = stats.active_campaigns;
                if (elAgents) elAgents.innerText = stats.connected_agents;
            }
